...
public class PathBezier2d : MonoBehaviour {
	...
	void Start () {
		// move 
		Vector3[] path = new Vector3[]{cubes[0].position, cubes[1].position, cubes[2].position, cubes[3].position, cubes[4].position, cubes[5].position, cubes[6].position, cubes[7].position,};
		// 90 degree test
